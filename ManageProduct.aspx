<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageProduct.aspx.cs" Inherits="agri.Vendor.ManageProduct" %>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
                   ...
                   <div class="col-xs-3">
      <a href="AddProduct.aspx" class="btn btn-block btn-success">Add Product</a>
                       </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <asp:Repeater ID="RepeatInformation" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <img src='../<%# Eval("img1") %>' alt="Product Image" style="width: 60px; height: auto;" />
                    </td>
                    <td>
