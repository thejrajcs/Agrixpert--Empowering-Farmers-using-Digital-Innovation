<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageScheme.aspx.cs" Inherits="agri.Vendor.ManageScheme" %>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
              <h3 class="box-title">Scheme Data</h3>
            <div class="box-header">
              
                   <div class="col-xs-3">
      <a href="AddScheme.aspx" class="btn btn-block btn-success">Add Scheme</a>
                       </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <asp:Repeater ID="RepeatInformation" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td><%# Convert.ToDateTime(Eval("CreatedOn")).ToString("dd/MM/yyyy") %></td>
                    <td>
                        <img src='../<%# Eval("pfile") %>' alt="Product Image" style="width: 60px; height: auto;" />
                    </td>
                    <td>
                        <button type="button" class="btn btn-block btn-danger btn-xs"
                                onclick="ClaimDelete(<%# Eval("id") %>)">
    ...
    <script>
               ...
               function ClaimDelete(id) {
                       ...
                       $.ajax({
                           ...
                           url: "ManageScheme.aspx/deleteClaim",
