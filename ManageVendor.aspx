<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageVendor.aspx.cs" Inherits="agri.Vendor.ManageVendor" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Vendor table</li>
      </ol>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
              <h3 class="box-title">Vendors Data</h3>
        ...
        <asp:Repeater ID="RepeatInformation" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td><%# Convert.ToDateTime(Eval("CreatedAt")).ToString("dd/MM/yyyy") %></td>
                 
                    <td>
                        <button type="button" class="btn btn-block btn-danger btn-xs"
                                onclick="ClaimDelete(<%# Eval("UserId") %>)">
...
<script>
    function ClaimDelete(id) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "This will delete the user and related product data!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: "ManageVendor.aspx/deleteClaim",
                    success: function (data) {
                        if (data.d == 1) {
                            Swal.fire('Deleted!', 'The user and related product data have been deleted.', 'success')
                                .then(() => window.location.reload());  // Reload the page after deletion
                        } else {
