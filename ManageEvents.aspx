<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageEvents.aspx.cs" Inherits="agri.Vendor.ManageEvents" %>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
                   ...
                   <div class="col-xs-3">
      <a href="AddEvent.aspx" class="btn btn-block btn-success">Add Events</a>
                       </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <asp:Repeater ID="RepeatInformation" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <img src='../<%# Eval("ImagePath") %>' alt="Product Image" style="width: 60px; height: auto;" />
                    </td>
                    <td>
                        <button type="button" class="btn btn-block btn-danger btn-xs"
                                onclick="ClaimDelete(<%# Eval("EventID") %>)">
    ...
    <script>
               ...
               function ClaimDelete(id) {
                       ...
                       $.ajax({
                           ...
                           url: "ManageEvents.aspx/deleteClaim",
