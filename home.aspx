<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="agri.Vendor.home" %>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6" >
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><asp:Label ID="Label1" runat="server" Text="Label">0</asp:Label></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
                  <asp:Label ID="Label2" runat="server" Text="Label">0</asp:Label><sup style="font-size: 20px">
            ...
            <a href="ManageVendor.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
          <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><asp:Label ID="Label3" runat="server" Text="Label">0</asp:Label><sup style="font-size: 20px"></sup></h3>
            ...
            <a href="ManageEvents.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
          <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-red">
            <div class="inner">
              <h3><asp:Label ID="Label4" runat="server" Text="Label">0</asp:Label><sup style="font-size: 20px"></sup></h3>
            ...
            <a href="ManageScheme.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
